...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      '@mui/material/Backdrop': path.resolve(__dirname, './src/alias/Backdrop'),
      '@mui/material/Tooltip': path.resolve(__dirname, './src/alias/Tooltip'),
      '@mui/material/PaginationItem': path.resolve(__dirname, './src/alias/PaginationItem'),
      '@mui/material/Pagination': path.resolve(__dirname, './src/alias/Pagination'),
      ...
      '@mui/icons-material/Settings': path.resolve(__dirname, './src/alias/SettingsIcon'),
      '@mui/material/colors': path.resolve(__dirname, './src/alias/colors'),
    },
  },
  plugins: [
    new CopyPlugin({
